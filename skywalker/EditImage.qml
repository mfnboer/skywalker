...
SkyPage {
    ...
    Image {
        ...
        function getImgStartScale() {
            if (sidesSwapped)
                return getNormalScale() * (boundingRect.getSwappedCutScale() / boundingRect.getNormalCutScale())
    ...
    Rectangle {
        ...
        readonly property double cutScale: img.sidesSwapped ? getSwappedCutScale() : getNormalCutScale()
        ...
        function updateCutRect(cutX, cutY, cutWidth, cutHeight) {
            ...
            const r = img.sidesSwapped ? boundingRect.getSwappedCutScale() / boundingRect.getNormalCutScale() : 1
            ...
            console.debug("CUT:", Qt.point(cutX, cutY), Qt.point(cx, cy), "WIDTH:", cutWidth, cw, "RATIO:", ratio, "CENTER:", center, "IMG CENTER:", img.getCenter(), "SCALE:", img.scale, "R:", r)
