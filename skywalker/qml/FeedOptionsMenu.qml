...
SkyMenu {
    ...
    SkyMenuButton {
        ...
        svg: SvgOutline.home
        popup: feedOptionsMenu
        enabled: skywalker.favoriteFeeds.homeFeedUri !== feedOptionsMenu.feed.key
        visible: isPinnedFeed
        onClicked: userSettings.setHomeFeedUri(skywalker.getUserDid(), feedOptionsMenu.feed.key)
    }
