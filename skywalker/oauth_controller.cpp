...
const QStringList SCOPE = {
    ...
    "rpc:chat.bsky.convo.getConvoMembers?aud=*",
    "rpc:chat.bsky.convo.getUnreadCounts?aud=*",
    "rpc:chat.bsky.convo.getMessages?aud=*",
    "rpc:chat.bsky.convo.leaveConvo?aud=*",
    "rpc:chat.bsky.convo.listConvoRequests?aud=*",
    "rpc:chat.bsky.convo.listConvos?aud=*",
    "rpc:chat.bsky.convo.lockConvo?aud=*",
    "rpc:chat.bsky.convo.muteConvo?aud=*",
    "rpc:chat.bsky.convo.removeReaction?aud=*",
    "rpc:chat.bsky.convo.sendMessage?aud=*",
    "rpc:chat.bsky.convo.unlockConvo?aud=*",
    "rpc:chat.bsky.convo.unmuteConvo?aud=*",
    "rpc:chat.bsky.convo.updateAllRead?aud=*",
    "rpc:chat.bsky.convo.updateRead?aud=*",

    "rpc:chat.bsky.group.addMembers?aud=*",
    "rpc:chat.bsky.group.approveJoinRequest?aud=*",
    "rpc:chat.bsky.group.createGroup?aud=*",
    "rpc:chat.bsky.group.createJoinLink?aud=*",
    "rpc:chat.bsky.group.disableJoinLink?aud=*",
    "rpc:chat.bsky.group.editGroup?aud=*",
    "rpc:chat.bsky.group.editJoinLink?aud=*",
    "rpc:chat.bsky.group.enableJoinLink?aud=*",
    "rpc:chat.bsky.group.getJoinLinkPreviews?aud=*",
    "rpc:chat.bsky.group.listJoinRequests?aud=*",
    "rpc:chat.bsky.group.listMutualGroups?aud=*",
    "rpc:chat.bsky.group.rejectJoinRequest?aud=*",
    "rpc:chat.bsky.group.removeMembers?aud=*",
    "rpc:chat.bsky.group.requestJoin?aud=*",
