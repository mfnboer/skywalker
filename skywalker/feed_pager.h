...
public:
    ...
    virtual void getTimelineForGap(int gapId, int autoGapFill = 0, bool userInitiated = false, const updateTimelineCb& cb = {}) = 0;
    ...
    virtual void syncFeed(int modelId) = 0;
    ...
    virtual void syncListFeed(int modelId) = 0;
